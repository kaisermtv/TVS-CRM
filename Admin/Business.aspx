...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
     <table class="table" border="0" style ="margin-top:-20px;">
        <tr>
            <td>
                <input type="text" id="txtSearch" placeholder="Tên ngành nghề cần tìm" runat="server" class="form-control" />
            </td>
    ...
    <div style="width: 100%; margin-top:-20px;">
        <table class="DataListTableHeader" border="0">
            <tr style="height: 36px;">
                ...
                <td class="DataListTableHeaderTdItemJustify" style="width: 81%;">Tên ngành nghề kinh doanh
                </td>
    ...
    <asp:DataList ID="dtlBusiness" runat="server" RepeatDirection="Horizontal" RepeatColumns="1"
        Width="100%">
        <ItemTemplate>
            <table class="DataListTable" border="0">
                <tr style="height: 36px;">
                    ...
                    <td class="DataListTableTdItemCenter" style="width: 3%;">
                        <a href="BusinessEdit.aspx?id=<%# Eval("Id") %>">
                            <img src="../Images/Edit.png" alt=""></a>
                    </td>
                    <td class="DataListTableTdItemCenter" style="width: 3%;">
                        <a href="BusinessDel.aspx?id=<%# Eval("Id") %>">
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-top: 5px; background-color: #fbf4f4; height: 26px;"
        ...
        <tr>
            <td style="padding-left: 6px;">
                <cc1:CollectionPager ID="cpBusiness" runat="server" BackText="" FirstText="Đầu"
