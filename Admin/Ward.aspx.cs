...
public partial class Admin_Ward : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            this.txtSearch.Value = this.objSearchConfig.getData(Session["ACCOUNT"].ToString(), "tblWard", "Name");
            this.getData();
        }
    } 
    #endregion
    ...
    protected void btnSearch_Click(object sender, ImageClickEventArgs e)
    {
        ...
        this.objSearchConfig.setData(Session["ACCOUNT"].ToString(), "tblWard", "Name", this.txtSearch.Value.Trim());
        #endregion
    }
    #endregion
    ...
    {
        this.objTable = this.objWard.getData(int.Parse(this.ddlProvincer.SelectedValue.ToString()), int.Parse(this.ddlDistrict.SelectedValue.ToString()), this.txtSearch.Value);
