...
public partial class Admin_Business : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            this.txtSearch.Value = this.objSearchConfig.getData(Session["ACCOUNT"].ToString(), "tblBusiness", "Name");
            this.getData();
        }
    ...
    {
        this.objTable = this.objBusiness.getData(this.txtSearch.Value);
    ...
    protected void btnSearch_Click(object sender, ImageClickEventArgs e)
    {
        ...
        this.objSearchConfig.setData(Session["ACCOUNT"].ToString(), "tblBusiness", "Name", this.txtSearch.Value.Trim());
        #endregion
    }
    #endregion
}