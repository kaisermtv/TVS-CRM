...
public partial class Admin_ChooseContact2 : System.Web.UI.Page
{
    ...
    {
        this.objTable = this.objContact.getData(this.txtSearch.Value);
    ...
    protected void btnSearch_Click(object sender, ImageClickEventArgs e)
    {
        ...
        this.objSearchConfig.setData(Session["ACCOUNT"].ToString(), "tblContact", "Name", this.txtSearch.Value.Trim());
        #endregion
    }
    #endregion
}