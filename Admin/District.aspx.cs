...
public partial class Admin_District : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            this.txtSearch.Value = this.objSearchConfig.getData(Session["ACCOUNT"].ToString(), "tblDistrict", "Name");
            this.getData();
        }
    }
    #endregion
    ...
    {
        this.objTable = this.objDistrict.getData(int.Parse(this.ddlProvincer.SelectedValue.ToString()), this.txtSearch.Value);
        cpDistrict.MaxPages = 1000;
        cpDistrict.PageSize = 10;
    ...
    protected void btnSearch_Click(object sender, ImageClickEventArgs e)
    {
        ...
        this.objSearchConfig.setData(Session["ACCOUNT"].ToString(), "tblDistrict", "Name", this.txtSearch.Value.Trim());
        #endregion
    }
    #endregion
