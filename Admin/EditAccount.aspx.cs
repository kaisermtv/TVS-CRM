...
public partial class Admin_EditAccount : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        if (this.objAccount.setData(this.itemId, this.txtUserName.Text, this.txtFullName.Text, this.txtEmail.Text,this.txtPassWord.Text, int.Parse(this.ddlGroupId.SelectedValue.ToString()), int.Parse(this.ddlTypeId.SelectedValue.ToString()), int.Parse(this.ddlProvincer.SelectedValue.ToString()), this.ckbState.Checked) == 1)
        {
