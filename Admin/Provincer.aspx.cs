...
public partial class Admin_Provincer : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            this.txtSearch.Value = this.objSearchConfig.getData(Session["ACCOUNT"].ToString(), "tblProvincer", "Name");
            this.getData();
        }
    } 
    #endregion
    ...
    {
        this.objTable = this.objProvincer.getData(this.txtSearch.Value);
    ...
    protected void btnSearch_Click(object sender, ImageClickEventArgs e)
    {
        ...
        this.objSearchConfig.setData(Session["ACCOUNT"].ToString(), "tblProvincer", "Name", this.txtSearch.Value.Trim());
        #endregion
    }
    #endregion
}