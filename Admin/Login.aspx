                ...
                <div class="col-md-12" style="text-align:center;">
                    ...
                    <div class="frmLogin">
                        <div class="form-group">
                            ...
                            <input runat="server" type="text" class="form-control" id="txtUserName" placeholder="Tên tài khoản" style="width: 410px !important; max-width: 450px !important;" />
                        </div>
                        <div class="form-group">
                            <label class="sr-only" for="pwd">Password:</label>
                            <input runat="server" type="password" class="form-control" id="txtPassWord" placeholder="Mật khẩu" style="width: 410px !important; max-width: 450px !important;" />
                        </div>
